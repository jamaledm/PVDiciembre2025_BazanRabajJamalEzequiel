...
export const TurnosProvider = ({ children }) => {
  ...
  // Recibe el ID del turno y filtra el array para eliminarlo.
  const cancelarTurno = (turnoId) => {
    const nuevosTurnos = turnos.filter((t) => t.id !== turnoId);
  ...
  return (
    <TurnosContext.Provider
      value={{
        ...
        logout,
        agendarTurno,
        cancelarTurno, // Agregado aquí para poder usarlo en Dashboard
        getHorariosOcupados,
      }}
    >
      {children}
